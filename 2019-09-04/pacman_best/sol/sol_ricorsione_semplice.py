...
def ric(r,c,b):
    ...
    if mappa[r][c] == '+':
        if b < MAXBLUE:
            ...
            if risp_up[0]:
                risp[0] = True
                if risp_up[1] >= risp[1] and ( risp_up[1] > risp[1] or risp_up[2] < risp[2] ):	
                    risp[1] = risp_up[1]
                    risp[2] = risp_up[2]
        if b == 0:
            ...
            if risp_left2[0]:
                risp[0] = True
                if risp_left2[1] >= risp[1] and ( risp_left2[1] > risp[1] or risp_left2[2] < risp[2] ):	
                    risp[1] = risp_left2[1]
                    risp[2] = risp_left2[2]
            if risp_up2[0]:
                risp[0] = True
                if risp_up2[1] >= risp[1] and ( risp_up2[1] > risp[1] or risp_up2[2] < risp[2] ):	
                    risp[1] = risp_up2[1]
                    risp[2] = risp_up2[2]
        ...
        if b < MAXBLUE:
            ...
            if risp_left[0]:
                risp[0] = True
                risp[1] = risp_left[1] +1
                risp[2] = risp_left[2]
            if risp_up[0]:
                risp[0] = True
                if risp_up[1] +1 >= risp[1] and ( risp_up[1] +1 > risp[1] or risp_up[2] < risp[2] ):	
                    risp[1] = risp_up[1] +1
                    risp[2] = risp_up[2] 
    else:
        ...
        if blue < b < MAXBLUE:
            ...
            if risp_left[0]:
                risp[0] = True
                risp[1] = risp_left[1]
                risp[2] = risp_left[2] +1
            if risp_up[0]:
                risp[0] = True
                if risp_up[1] >= risp[1] and ( risp_up[1] > risp[1] or risp_up[2] +1 < risp[2] ):	
                    risp[1] = risp_up[1]
                    risp[2] = risp_up[2] +1
        ...
        if b == blue:
            for bb in range(blue+2):
                if bb <= MAXBLUE:
                    ...
                    if risp_left[0]:
                        risp[0] = True
                        if risp_left[1] >= risp[1] and ( risp_left[1] > risp[1] or risp_left[2] +1 < risp[2] ):
                            risp[1] = risp_left[1]
                            risp[2] = risp_left[2] +1
                    if risp_up[0]:
                        risp[0] = True
