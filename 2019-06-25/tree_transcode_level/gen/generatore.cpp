 ...
 * last change: 2019-06-25 author: Romeo Rizzi
 ...
 * if format=2 the tree is encoded as in the "tree_transcode" problem: evey node reports its depth (distance from the root) both when it is opened and when it is closed in the DFS visit of the tree.  
 * 
 */
